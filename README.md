...
**Ascension Cast Bar** is a highly customizable replacement for the default World of Warcraft player's casting bar, built on the Ace3 framework. Designed to offer a modern and dynamic visual experience, it features an advanced animation system for the "spark" (the indicator of casting progress).
...
*   **Integration:** Features built-in support to attach the cast bar to the in game Cooldown Manager (CDM) and action bar. If you are using [bartender 4](https://www.curseforge.com/wow/addons/bartender4) add on you can also attach the cast bar to most action bars. It also supports the [Coolinator](https://www.curseforge.com/wow/addons/coolinator) cooldown manager.
...
**Ascension Cast Bar** es un sustituto altamente personalizable de la barra de lanzamiento predeterminada del jugador de World of Warcraft, creado con el marco Ace3. Diseñado para ofrecer una experiencia visual moderna y dinámica, cuenta con un sistema de animación avanzado para la «chispa» (el indicador del progreso del lanzamiento).
